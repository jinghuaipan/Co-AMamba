...
class Config():
    def __init__(self) -> None:
        ...
        self.val_measures = {
            'Emax': {'CoCA': 0.783, 'CoSOD3k': 0.874, 'CoSal2015': 0.892, 'MSRC': 0.001},
            'Smeasure': {'CoCA': 0.310, 'CoSOD3k': 0.810, 'CoSal2015': 0.338, 'MSRC': 0.001},
            'Fmax': {'CoCA': 0.598, 'CoSOD3k': 0.805, 'CoSal2015': 0.856, 'MSRC': 0.001},
            'MAE': {'CoCA': 0.001, 'CoSOD3k': 0.001, 'CoSal2015': 0.001, 'MSRC': 0.001},
        }
        # Components
        self.consensus = ['', 'GCAM', 'GWM', 'SGS'][0]
        self.dec_blk = ['ResBlk'][0]
        self.GCAM_metric = ['online', 'offline', ''][1] if self.consensus else ''
        # Training
        self.batch_size = 16
        self.loadN = 2
        self.dec_att = ['', 'ASPP'][0]
        ...
        # Adv
        ##self.lambda_adv_g = 0    #10. * 1        # turn to 0 to avoid adv training
        ## = 3. * (self.lambda_adv_g > 0)
        # Loss
        losses = ['sal', 'contrast']
        self.loss = losses[:]
